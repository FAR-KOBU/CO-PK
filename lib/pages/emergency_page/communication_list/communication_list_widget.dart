...
import 'communication_list_model.dart';
export 'communication_list_model.dart';

class CommunicationListWidget extends StatefulWidget {
  const CommunicationListWidget({super.key});

  static String routeName = 'CommunicationList';
  static String routePath = 'communicationList';
...
class _CommunicationListWidgetState extends State<CommunicationListWidget> {
  late CommunicationListModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CommunicationListModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'CommunicationList'});
                                  ...
                                  children: [
                                    Expanded(
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'COMMUNICATION_LIST_Container_y9s6e3v9_ON');
                                          logFirebaseEvent(
                                    ...
                                    Expanded(
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'COMMUNICATION_LIST_Container_yjdl9193_ON');
                                          logFirebaseEvent(
                                              'Container_set_dark_mode_settings');
                                          setDarkModeSetting(
