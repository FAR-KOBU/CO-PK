      ...
      routes: [
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              name: CommunicationListWidget.routeName,
              path: CommunicationListWidget.routePath,
              builder: (context, params) => params.isEmpty
                  ? NavBarPage(initialPage: 'CommunicationList')
            ...
            FFRoute(
              ...
              builder: (context, params) => params.isEmpty
                  ? NavBarPage(initialPage: 'IncidentDetails')
                  : IncidentDetailsWidget(),
            ),
            FFRoute(
              name: IncidentCommandPostWidget.routeName,
              path: IncidentCommandPostWidget.routePath,
              builder: (context, params) => params.isEmpty
                  ? NavBarPage(initialPage: 'IncidentCommandPost')
                  : IncidentCommandPostWidget(),
            )
